...
const HeroSection = memo(function HeroSection({ onLoginClick }: { onLoginClick?: () => void }) {
  return (
    <section
      ...
      className="flex-1 relative bg-cover bg-center ys-slide-in-left motion-reduce:transform-none motion-reduce:transition-none motion-reduce:animate-none"
      style={{ backgroundImage: `url(${desktopBg})` }}
    >
      <div 
        aria-hidden="true" 
        className="absolute inset-0 bg-gradient-to-r from-[#050f20]/90 via-[#071428]/70 to-transparent" 
      />
      ...
      <div className="relative z-10 flex flex-col justify-between h-full px-10 py-8 max-w-[520px]">
        <div className="mt-2">
          ...
          <h1 className="text-white text-[2.1rem] font-extrabold leading-[1.15] tracking-tight drop-shadow-lg">
            ...
            Real Estate Platform <span className="text-[#4ade80]">Yard</span>
          </h1>
        ...
        <div className="bg-white/15 backdrop-blur-xl border border-white/20 rounded-[8px] p-2 mb-20 shadow-[0_8px_32px_rgba(0,0,0,0.15)] hover:bg-white/20 hover:shadow-[0_8px_32px_rgba(0,0,0,0.25)] transition-all duration-500 group motion-reduce:transition-none">
          ...
          <p className="text-white/90 text-[0.8rem] text-center mt-2 border-t border-white/15 pt-2 pb-1">
            ...
            <button 
              ...
              className="text-[#4ade80] font-bold hover:text-white hover:underline transition-all underline duration-300 rounded-[2px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4ade80] focus-visible:ring-offset-2 focus-visible:ring-offset-[#071428] motion-reduce:transition-none"
            >
              Login here
            </button>
          </p>
  ...
  return (
    <main className="h-screen w-full flex overflow-hidden bg-[#050f20]">
      ...
      <section 
        ...
        className="w-[640px] shrink-0 bg-white flex flex-col shadow-[-12px_0_40px_rgba(0,0,0,0.12)] z-10 relative ys-slide-in-right motion-reduce:transform-none motion-reduce:animate-none"
      >
