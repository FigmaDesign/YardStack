...
export default function CreateAccountDesktop({ language, setLanguage, onLoginClick, ...formProps }: CreateAccountDesktopProps) {
  return (
    <div className="h-screen w-full flex overflow-hidden">
      ...
      <div
        className="flex-1 relative bg-cover bg-center ys-slide-in-left"
          ...
          <div className="mt-2">
            ...
            <div className="mt-7 space-y-2">
              {FEATURES.map(({ Icon, title, desc }, idx) => (
                <div key={title} className="flex items-center gap-3 p-2.5 rounded-[8px] hover:bg-white/10 hover:-translate-y-0.5 border border-transparent hover:border-white/10 transition-all duration-300 cursor-default hover:shadow-[0_8px_24px_rgba(0,0,0,0.2)] group ys-fade-in-up" style={{ animationDelay: `${idx * 90}ms` }}>
      ...
      <div className="w-[640px] shrink-0 bg-white flex flex-col shadow-[-12px_0_40px_rgba(0,0,0,0.12)] z-10 relative ys-slide-in-right">
