...
export default function LoginMobile({
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-linear-to-b from-[#050f20]/65 via-[#071428]/50 to-[#0a1a30]/30" />
        <div className="relative z-10 h-full flex flex-col px-5 pt-5 pb-4">
          <div className="flex items-center gap-2.5">
            <img src="/src/components/commonfiles/Images/YardStackLogowithouttext.png" alt="Yard" className="w-9 h-9 object-contain" />
            <div>
              <p className="text-white font-extrabold text-[1.1rem] tracking-widest leading-none">YARD</p>
              <p className="text-white/55 text-[0.47rem] tracking-[0.22em] uppercase mt-0.5">REAL ESTATE INTELLIGENCE</p>
            </div>
          </div>
          <div className="mt-auto">
            <h2 className="text-white text-[1.65rem] font-extrabold leading-tight">
      ...
      <div className="flex-1 overflow-y-auto bg-white rounded-t-[32px] -mt-5 relative z-10 shadow-[0_-8px_32px_rgba(0,0,0,0.18)]">
